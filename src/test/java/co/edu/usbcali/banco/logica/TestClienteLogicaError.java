...
class TestClienteLogicaError {
	...
	private final static Logger log = LoggerFactory.getLogger(TestClienteLogicaError.class);
	...
	public void aTest() throws Exception {
		...
		cliente.setEmail("hsimpson@gmail");
		cliente.setNombre("Homer J Simpson");
		cliente.setTelefono("645a163");
